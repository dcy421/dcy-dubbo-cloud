package com.dcy.service.bizganerate;
...
import com.dcy.service.bizganerate.model.GenerModel;
import com.dcy.service.bizganerate.utils.GenUtils;
...
public class SimpleGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.dcy.service");
        pc.setController("biz"+generModel.getModules()+".controller");
        pc.setEntity("api"+generModel.getModules()+".model");
        pc.setService("api"+generModel.getModules()+".api");
        pc.setServiceImpl("provider"+generModel.getModules()+".service");
        pc.setMapper("provider"+generModel.getModules()+".mapper");
        pc.setXml("mapper");
